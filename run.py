...
# Function to pick a ship on the board on a column.
...
def play_battleships(size):
    ...
    for turn in range(4):
        ...
        if guess_row == computer_ship_row and guess_col == computer_ship_col:
            ...
            if computer_guess_row == computer_ship_row and
            computer_guess_col == computer_ship_col:
                ...
                [computer_guess_col] == "X":
                    ...
                    computer_board[computer_guess_row]
                    [computer_guess_col] = "X"
